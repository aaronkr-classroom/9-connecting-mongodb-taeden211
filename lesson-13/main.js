...
const port = 3000,
  ...
  dbURL='mongodb+srv://ut-node:1Sz9SxHqPOOBe7LQ@taeden.wxgncva.mongodb.net/?retryWrites=true&w=majority&appName=taeden',
  dbName='ut-node';
  // @TODO: 몽고DB 모듈의 요청
...
MongoDB.connect(dbURL, (error,client)=> {
  ...
  let db = client.db(dbName);//ut_ndoe
